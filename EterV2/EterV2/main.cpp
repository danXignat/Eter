...
void testArenaService() {
	...
	board.appendMove({ 10, 5 }, base::CombatCard(base::CombatCardType::ONE, color::ColorType::BLUE));
	board.appendMove({ 12, 5 }, base::CombatCard(base::CombatCardType::TWO, color::ColorType::BLUE));
	board.appendMove({ 14, 5 }, base::CombatCard(base::CombatCardType::THREE, color::ColorType::BLUE));
	board.appendMove({ 16, 5 }, base::CombatCard(base::CombatCardType::FOUR, color::ColorType::BLUE));
	board.appendMove({ 10, 6 }, base::CombatCard(base::CombatCardType::FOUR, color::ColorType::RED));
	board.appendMove({ 10, 4 }, base::CombatCard(base::CombatCardType::TWO, color::ColorType::RED));
	board.appendMove({ 10, 3 }, base::CombatCard(base::CombatCardType::TWO, color::ColorType::RED));
	...
	//arenaService.placeMarker({ 14, 6 }, board, color::ColorType::RED);
}
...
int main() {
  ...
  /*  base::GameModePtr game_mode{ base::GameModeFactory::get("323", { "titi", "gigi" }) };
	game_mode->run();*/
